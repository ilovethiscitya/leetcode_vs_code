...
class Solution {
    public String tree2str(TreeNode t) {
        if(t == null) return "";
        StringBuilder sb = buildStr(t);
        return sb.toString();
    }
    private StringBuilder buildStr(TreeNode node) {
        StringBuilder sb = new StringBuilder();
        if(node.left != null || node.right != null) {
            sb.append("(");
            if(node.left != null) {
                StringBuilder leftString = buildStr(node.left);
        ...
        if(node.right != null) {
            sb.append("(");
            StringBuilder rightString = buildStr(node.right);
